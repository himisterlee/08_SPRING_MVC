...
public class FileUploadController {
    ...
    public String singleFileUpload(@RequestParam MultipartFile singleFile,
        ...
        // classpath: 클래스의 resources 까자의 경로로 가져다 준다.

        String filePath = null;

        // 폴더가 있을때, 없을때에 따라 저장경로를 지정해줘야 한다.
        if (!resource.exists()) {
        ...
        log.info("originFileName : {}", originFileName); // 팀프로젝트 진행순서.PNG
        ...
        log.info("saveName : {}", saveName); // saveName : dcffec4afaef4c5682b650ba9f99fe67
    ...
    public String multiFileUpload(@RequestParam List<MultipartFile> multiFiles,
        ...
        try {
            ...
            for (MultipartFile file : multiFiles) {
                ...
                saveFiles.add("static/img/multi/"+saveName);
            }
